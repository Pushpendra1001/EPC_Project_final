...
import 'package:epc/dashboard/dashboard.dart';
...
class AuthenticationRepositary extends GetxController{
  ...
  _setInitialScreen(User? user){
    ...
    user == null? Get.offAll(()=> const startscreen() ) :
    //  user.emailVerified? 
  ...
  void createUserWithEmailandPassword(String email,String password)async{
    try{
      ...
      // Get.to(()=>otpscreen());
      firebaseUser.value != null ? Get.offAll(()=> const dashboard()) : Get.back();
  ...
  Future<void> loginWithEmailAndPassword(String email, String password)async{
    try{
      ...
      firebaseUser.value != null ? Get.offAll(()=> const dashboard()) : Get.to(()=> const startscreen());
    } on FirebaseAuthException catch(e){
      Get.snackbar("Error", "$e",
